...
class homePgStrip1Pad extends StatefulWidget {
  const homePgStrip1Pad({super.key});

  @override
  State<homePgStrip1Pad> createState() => _homePgStrip1PadState();
}

class _homePgStrip1PadState extends State<homePgStrip1Pad> {
